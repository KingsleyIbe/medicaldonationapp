  ...
  <div className="p-10">
    ...
    <ul className="mb-2 ml-10">
      ...
      <li>
        ...
        functionalities of the Service that are available
      ...
      <li>
        ...
        the purchase contract for the products,
        items or services You have purchased or of any
      ...
      <li>
        ...
        or another sale or transfer of some or all of Our assets,
        whether as a going concern or as part of bankruptcy, liquidation,
        or similar proceeding, in which Personal Data held by Us about
    ...
    <ul className="mb-2 ml-10">
      ...
      <li>
        ...
        in which case we will require those affiliates to honour
      ...
      <li>
        ...
        in public areas with other users, such information may be
    ...
    <h3 className="text-[#17a2b8] text-[18px] mb-2">Retention of Your Personal Data</h3>
    <p className="mb-2">
    ...
    <h3 className="text-[#17a2b8] text-[18px] my-2">Transfer of Your Personal Data</h3>
    <p>
    ...
    <h3 className="text-[#17a2b8] text-[18px] my-2">Delete Your Personal Data</h3>
    <p>
      You have the right to delete or request that We assist
      in deleting the Personal Data that We have collected about You.
    </p>
    <p className="my-2">
    ...
    <p>
      ...
      visiting the account settings section that allows you to manage
      Your personal information. You may also contact Us to request access to,
    ...
    <h3 className="text-[#17a2b8] text-[20px] mb-2">Disclosure of Your Personal Data</h3>
    <h4 className="text-[#17a2b8] text-[18px] mb-2">Business Transactions</h4>
    <p className="mb-2">
      If the Company is involved in a merger, acquisition or asset sale,
      Your Personal Data may be transferred. We will provide notice before
      Your Personal Data is transferred and becomes
      subject to a different Privacy Policy.
    </p>
    <h4 className="text-[#17a2b8] text-[18px] mb-2">Law enforcement</h4>
    <p className="mb-2">
    ...
    <h4 className="text-[#17a2b8] text-[18px] mb-2">Other legal requirements</h4>
    <p className="mb-2">
    ...
    <h4 className="text-[#17a2b8] text-[18px] mb-2">Security of Your Personal Data</h4>
    <p className="mb-2">
    ...
    <h2 className="text-[#17a2b8] text-[25px] my-5">Children&#39;s Privacy</h2>
    <p className="mb-2">
      Our Service does not address anyone under the age of 13.
      We do not knowingly collect personally identifiable information
      from anyone under the age of 13. If You are a parent or guardian
      and You are aware that Your child has provided Us with Personal Data,
    ...
    <h2 className="text-[#17a2b8] text-[25px] my-5">Links to Other Websites</h2>
    <p className="mb-2">
    ...
    <h2 className="text-[#17a2b8] text-[25px] my-5">Changes to this Privacy Policy</h2>
    <p className="mb-2">
    ...
    <h2 className="text-[#17a2b8] text-[25px] my-5">Contact Us</h2>
    <p className="mb-2">
      If you have any questions about this Privacy Policy, You can contact us:
    </p>
    <ul className="ml-10 mb-10">
      <li>By email: support@lifeforce.com</li>
      <li>By visiting this page on our website: http://www.lifeforce.com/contact</li>
    </ul>
  </div>
);
