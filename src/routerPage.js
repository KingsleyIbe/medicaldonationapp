...
const RouterPage = () => (
  <>
    <Routes>
      ...
      <Route exact path="/dashboard/donate-item" element={<DashboardPage />} />
      ...
      <Route exact path="/dashboard/help" element={<DashboardPage />} />
      <Route exact path="/dashboard/policy" element={<DashboardPage />} />
      <Route exact path="/dashboard/feedback" element={<DashboardPage />} />
